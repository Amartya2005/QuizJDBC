...
CallableStatement used to retrieve result
...
It counts the number of correct answers for a given student.

This procedure is executed from Java using a CallableStatement.
...
Application starts and establishes a database connection

Student logs in using roll number and password

Quiz questions are fetched from the database

Options are shuffled and displayed

Student answers are recorded in the result table

Stored procedure is called to calculate score
...
Insert at least one student and some questions
...
CallableStatement is used to execute a stored procedure that calculates the final score
